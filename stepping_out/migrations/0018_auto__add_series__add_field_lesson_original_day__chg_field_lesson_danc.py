...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Series'
        db.create_table(u'stepping_out_series', (
            ...
            ('start_day', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('lesson_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.LessonTemplate'], null=True, blank=True)),
        ))
        db.send_create_signal(u'stepping_out', ['Series'])

        # Adding field 'Lesson.original_day'
        db.add_column(u'stepping_out_lesson', 'original_day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Lesson.dance'
        db.alter_column(u'stepping_out_lesson', 'dance_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['stepping_out.Dance']))
        # Adding field 'Dance.original_day'
        db.add_column(u'stepping_out_dance', 'original_day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Venue.start_day'
        db.add_column(u'stepping_out_venue', 'start_day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Venue.end_day'
        db.add_column(u'stepping_out_venue', 'end_day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'stepping_out_series')

        # Deleting field 'Lesson.original_day'
        db.delete_column(u'stepping_out_lesson', 'original_day')


        # User chose to not deal with backwards NULL issues for 'Lesson.dance'
        raise RuntimeError("Cannot reverse this migration. 'Lesson.dance' and its values cannot be restored.")
        # Deleting field 'Dance.original_day'
        db.delete_column(u'stepping_out_dance', 'original_day')

        # Deleting field 'Venue.start_day'
        db.delete_column(u'stepping_out_venue', 'start_day')

        # Deleting field 'Venue.end_day'
        db.delete_column(u'stepping_out_venue', 'end_day')
    ...
    models = {
        ...
        u'stepping_out.dance': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'original_day': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'stepping_out.lesson': {
            ...
            'custom_price': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'dance': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lessons'", 'null': 'True', 'to': u"orm['stepping_out.Dance']"}),
        ...
        u'stepping_out.series': {
            'Meta': {'object_name': 'Series'},
            'banner': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'end_day': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lesson_template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stepping_out.LessonTemplate']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
