...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'stepping_out_location', (
        ...
        db.send_create_signal(u'stepping_out', ['Location'])

        # Adding field 'Lesson.location'
        db.add_column(u'stepping_out_lesson', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DanceTemplate.location'
        db.add_column(u'stepping_out_dancetemplate', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dance.location'
        db.add_column(u'stepping_out_dance', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'LessonTemplate.location'
        db.add_column(u'stepping_out_lessontemplate', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.Location'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'stepping_out_location')

        # Deleting field 'Lesson.location'
        db.delete_column(u'stepping_out_lesson', 'location_id')

        # Deleting field 'DanceTemplate.location'
        db.delete_column(u'stepping_out_dancetemplate', 'location_id')

        # Deleting field 'Dance.location'
        db.delete_column(u'stepping_out_dance', 'location_id')

        # Deleting field 'LessonTemplate.location'
        db.delete_column(u'stepping_out_lessontemplate', 'location_id')
