...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sites on 'LessonTemplate'
        db.create_table(u'stepping_out_lessontemplate_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lessontemplate', models.ForeignKey(orm[u'stepping_out.lessontemplate'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'stepping_out_lessontemplate_sites', ['lessontemplate_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'LessonTemplate'
        db.delete_table('stepping_out_lessontemplate_sites')
    ...
    models = {
        ...
        u'stepping_out.lesson': {
            ...
            'original_day': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'price': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'series': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lessons'", 'null': 'True', 'to': u"orm['stepping_out.Series']"}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['sites.Site']", 'symmetrical': 'False', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'student_price': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
