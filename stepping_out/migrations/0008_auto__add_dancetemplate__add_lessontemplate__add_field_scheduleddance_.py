...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'stepping_out', ['DanceTemplate'])

        # Adding M2M table for field sites on 'DanceTemplate'
        db.create_table(u'stepping_out_dancetemplate_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dancetemplate', models.ForeignKey(orm[u'stepping_out.dancetemplate'], null=False)),
