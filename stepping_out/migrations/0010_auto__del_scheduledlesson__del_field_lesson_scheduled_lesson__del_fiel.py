...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lesson.scheduled_lesson'
        db.delete_column(u'stepping_out_lesson', 'scheduled_lesson_id')

        # Deleting field 'ScheduledDance.end'
        db.delete_column(u'stepping_out_scheduleddance', 'end')

        # Deleting field 'ScheduledDance.venue'
        db.delete_column(u'stepping_out_scheduleddance', 'venue_id')

        # Deleting field 'ScheduledDance.start'
        db.delete_column(u'stepping_out_scheduleddance', 'start')

        # Removing M2M table for field sites on 'ScheduledDance'
        db.delete_table('stepping_out_scheduleddance_sites')


        # Changing field 'LessonTemplate.dance_template'
        db.alter_column(u'stepping_out_lessontemplate', 'dance_template_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['stepping_out.DanceTemplate']))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Lesson.scheduled_lesson'
        db.add_column(u'stepping_out_lesson', 'scheduled_lesson',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='lessons', null=True, to=orm['stepping_out.ScheduledLesson'], blank=True),
                      keep_default=False)

        # Adding field 'ScheduledDance.end'
        db.add_column(u'stepping_out_scheduleddance', 'end',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScheduledDance.venue'
        db.add_column(u'stepping_out_scheduleddance', 'venue',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='scheduled_dances', null=True, to=orm['stepping_out.Venue'], blank=True),
                      keep_default=False)

        # Adding field 'ScheduledDance.start'
        db.add_column(u'stepping_out_scheduleddance', 'start',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'LessonTemplate.dance_template'
        raise RuntimeError("Cannot reverse this migration. 'LessonTemplate.dance_template' and its values cannot be restored.")
