...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sites on 'Lesson'
        db.create_table(u'stepping_out_lesson_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm[u'stepping_out.lesson'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'stepping_out_lesson_sites', ['lesson_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'Lesson'
        db.delete_table('stepping_out_lesson_sites')
