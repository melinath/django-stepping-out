...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venue.neighborhood'
        db.add_column(u'stepping_out_venue', 'neighborhood',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venue.neighborhood'
        db.delete_column(u'stepping_out_venue', 'neighborhood')
