...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dance.scheduled_dance'
        db.delete_column(u'stepping_out_dance', 'scheduled_dance_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'stepping_out_scheduleddance', (
            ...
            ('dance_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.DanceTemplate'], null=True, blank=True)),
        ...
        # Adding field 'Dance.scheduled_dance'
        db.add_column(u'stepping_out_dance', 'scheduled_dance',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dances', null=True, to=orm['stepping_out.ScheduledDance'], blank=True),
                      keep_default=False)
