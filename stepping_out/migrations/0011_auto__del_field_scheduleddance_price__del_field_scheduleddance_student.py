...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScheduledDance.price'
        db.delete_column(u'stepping_out_scheduleddance', 'price')

        # Deleting field 'ScheduledDance.student_price'
        db.delete_column(u'stepping_out_scheduleddance', 'student_price')

        # Deleting field 'ScheduledDance.custom_price'
        db.delete_column(u'stepping_out_scheduleddance', 'custom_price')


    def backwards(self, orm):
        # Adding field 'ScheduledDance.price'
        db.add_column(u'stepping_out_scheduleddance', 'price',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ScheduledDance.student_price'
        db.add_column(u'stepping_out_scheduleddance', 'student_price',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScheduledDance.custom_price'
        db.add_column(u'stepping_out_scheduleddance', 'custom_price',
