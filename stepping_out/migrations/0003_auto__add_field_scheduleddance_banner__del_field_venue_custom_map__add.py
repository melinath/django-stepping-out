...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledDance.banner'
        db.add_column(u'stepping_out_scheduleddance', 'banner',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Venue.custom_map'
        db.delete_column(u'stepping_out_venue', 'custom_map')

        # Adding field 'Venue.custom_map_url'
        db.add_column(u'stepping_out_venue', 'custom_map_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Venue.custom_map_image'
        db.add_column(u'stepping_out_venue', 'custom_map_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Dance.banner'
        db.add_column(u'stepping_out_dance', 'banner',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledDance.banner'
        db.delete_column(u'stepping_out_scheduleddance', 'banner')

        # Adding field 'Venue.custom_map'
        db.add_column(u'stepping_out_venue', 'custom_map',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Venue.custom_map_url'
        db.delete_column(u'stepping_out_venue', 'custom_map_url')

        # Deleting field 'Venue.custom_map_image'
        db.delete_column(u'stepping_out_venue', 'custom_map_image')

        # Deleting field 'Dance.banner'
        db.delete_column(u'stepping_out_dance', 'banner')
