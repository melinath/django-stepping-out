...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ScheduledLesson = orm['stepping_out.scheduledlesson']
        DanceTemplate = orm['stepping_out.dancetemplate']
        LessonTemplate = orm['stepping_out.lessontemplate']

        for sd in ScheduledDance.objects.all():
            dt = DanceTemplate.objects.create(
                name=sd.name,
                banner=sd.banner,
                description=sd.description,
                venue=sd.venue,
                price=sd.price,
                student_price=sd.student_price,
            ...
            for sl in sd.scheduled_lessons.all():
                lt = LessonTemplate.objects.create(
                    ...
                    venue=sl.venue,
                    price=sl.price,
                    student_price=sl.student_price,
                    custom_price=sl.custom_price,
                    start_time=sl.start,
                    end_time=sl.end,
    ...
    def backwards(self, orm):
        ...
        #orm['stepping_out.dancetemplate'].objects.all().delete()
    ...
    models = {
        ...
        u'stepping_out.lessontemplate': {
            ...
            'custom_price': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'dance_included': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'dance_template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lesson_templates'", 'to': u"orm['stepping_out.DanceTemplate']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'end_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
