...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.series'
        db.add_column(u'stepping_out_lesson', 'series',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.Series'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.series'
        db.delete_column(u'stepping_out_lesson', 'series_id')
    ...
    models = {
        ...
        u'stepping_out.lesson': {
            ...
            'original_day': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'price': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'series': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stepping_out.Series']", 'null': 'True', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'student_price': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
