...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Lesson', fields ['dance', 'slug']
        db.delete_unique(u'stepping_out_lesson', ['dance_id', 'slug'])

        # Deleting field 'Lesson.slug'
        db.delete_column(u'stepping_out_lesson', 'slug')

        # Deleting field 'LiveAct.slug'
        db.delete_column(u'stepping_out_liveact', 'slug')

        # Deleting field 'ScheduledDance.slug'
        db.delete_column(u'stepping_out_scheduleddance', 'slug')

        # Deleting field 'Person.slug'
        db.delete_column(u'stepping_out_person', 'slug')

        # Deleting field 'ScheduledLesson.slug'
        db.delete_column(u'stepping_out_scheduledlesson', 'slug')

        # Deleting field 'Venue.slug'
        db.delete_column(u'stepping_out_venue', 'slug')

        # Deleting field 'Dance.slug'
        db.delete_column(u'stepping_out_dance', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Lesson.slug'
        raise RuntimeError("Cannot reverse this migration. 'Lesson.slug' and its values cannot be restored.")
        # Adding unique constraint on 'Lesson', fields ['dance', 'slug']
        db.create_unique(u'stepping_out_lesson', ['dance_id', 'slug'])


        # User chose to not deal with backwards NULL issues for 'LiveAct.slug'
        raise RuntimeError("Cannot reverse this migration. 'LiveAct.slug' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ScheduledDance.slug'
        raise RuntimeError("Cannot reverse this migration. 'ScheduledDance.slug' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'ScheduledLesson.slug'
        raise RuntimeError("Cannot reverse this migration. 'ScheduledLesson.slug' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'Venue.slug'
        raise RuntimeError("Cannot reverse this migration. 'Venue.slug' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Dance.slug'
        raise RuntimeError("Cannot reverse this migration. 'Dance.slug' and its values cannot be restored.")
